export const enum ShapeFlags {
    ELEMENT = 1,// 1
    FUNCTIONAL_COMPONENT = 1 << 1, // 2 2^1
    STATEFUL_COMPONENT = 1 << 2, // 4  => 2^2
    TEXT_CHILDREN = 1 << 3, // 8  => 2^3
    ARRAY_CHILDREN = 1 << 4, // => 2^4
    SLOTS_CHILDREN = 1 << 5, // => 2^5
    TELEPORT = 1 << 6, // => 2^6
    SUSPENSE = 1 << 7, // => 2^7
    COMPONENT_SHOULD_KEEP_ALIVE = 1 << 8, // => 2^8
    COMPONENT_KEPT_ALIVE = 1 << 9, // => 2^9
